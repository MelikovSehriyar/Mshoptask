  ...
  return (
    <div>
      <div className={styles.textss3}>
        <p className={styles.offerour}>Our Offers </p>
        <h1 className={styles.summer}>Our Offer This Summer</h1>
      ...
      {data?.map((item) => (
        <div className={styles.cardsdata}>
          ...
          <button onClick={() => {addToCart(item)}} className={styles.order}>Order Now!</button>
        </div>
        </div>
      ))}
      </div>
